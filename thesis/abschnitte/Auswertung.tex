...
\newcommand{\wheelcasepheno}[1]{
	\begin{figure}[h]
		...
		\begin{minipage}{0.5\textwidth}
			...
			\label{fig:wheelcasepheno#1-front}
		\end{minipage}\hfill
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=1\linewidth]{bilder/escooter/#1-side.png}
			\caption{Phänotyp des Individuums (#1), Seite}
			\label{fig:wheelcasepheno#1-side}
		\end{minipage}
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=1\linewidth]{bilder/escooter/#1-front.png}
			\caption{Phänotyp des Individuums (#1), oben rechts}
			\label{fig:wheelcasepheno#1-isometric}
		\end{minipage}\hfill
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=1\linewidth]{bilder/escooter/#1-side.png}
...
Das Individuum (9,16) dargestellt in \allrefEscooter{23-22} befindet sich am Dreiecksrand der Karte.
...
In \allrefEscooter{20-5} ist das Individuum (20,5) abgebildet, welches nicht das extremste Individuum der rechten Ecke ist, sondern, das welches den optimalen Fitnesswert aufweist.
