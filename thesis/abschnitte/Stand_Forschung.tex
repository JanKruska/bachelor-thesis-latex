...
Diese beiden wichtigsten genutzten OpenFoam-Funktionen sind \path{snappyHexMesh} und \path{simpleFoam}.
...
snappyHexMesh ist ein auf Octrees \cite{quelle} basierender Verfeinerungsalgorithmus.
...
simpleFoam implementiert den SIMPLE (Semi-Implicit Method for Pressure Linked Equations) Algorithmus der in \todo{cite simple} beschrieben wurde.
